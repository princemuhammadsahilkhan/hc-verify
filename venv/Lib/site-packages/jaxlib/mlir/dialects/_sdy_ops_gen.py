...
@_ods_cext.register_operation(_Dialect)
class FuncDataFlowEdgeOp(_ods_ir.OpView):
  r"""
  ...
  OPERATION_NAME = "sdy.func_data_flow_edge"
...
@_ods_cext.register_op_adaptor(FuncDataFlowEdgeOp)
class FuncDataFlowEdgeOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sdy.func_data_flow_edge"
