...
class EnqueueDMAOp(_ods_ir.OpView):
  ...
  _ODS_OPERAND_SEGMENTS = [1,0,1,0,0,0,]

  _ODS_REGIONS = (0, True)

  def __init__(self, source: _ods_ir.Value[_ods_ir.MemRefType], target: _ods_ir.Value[_ods_ir.MemRefType], *, source_semaphore: _Optional[_ods_ir.Value[_ods_ir.MemRefType]] = None, target_semaphore: _Optional[_ods_ir.Value[_ods_ir.MemRefType]] = None, device_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, core_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, priority: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, strict_ordering: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
    operands.append(source)
...
def enqueue_dma(source: _ods_ir.Value[_ods_ir.MemRefType], target: _ods_ir.Value[_ods_ir.MemRefType], *, source_semaphore: _Optional[_ods_ir.Value[_ods_ir.MemRefType]] = None, target_semaphore: _Optional[_ods_ir.Value[_ods_ir.MemRefType]] = None, device_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, core_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, priority: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, strict_ordering: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None) -> EnqueueDMAOp:
  return EnqueueDMAOp(source=source, target=target, source_semaphore=source_semaphore, target_semaphore=target_semaphore, device_id=device_id, core_id=core_id, priority=priority, strict_ordering=strict_ordering, loc=loc, ip=ip)
...
class ReinterpretCastOp(_ods_ir.OpView):
  ...
  def __init__(self, result: _ods_ir.Type, input: _ods_ir.Value[_ods_ir.MemRefType], *, dynamic_offset: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None):
    operands = []
    attributes = {}
    regions = None
    operands.append(input)
    if dynamic_offset is not None: operands.append(dynamic_offset)
    _ods_context = _ods_get_default_loc_context(loc)
    results = []
    results.append(result)
    _ods_successors = None
...
def reinterpret_cast(result: _ods_ir.Type, input: _ods_ir.Value[_ods_ir.MemRefType], *, dynamic_offset: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None) -> _ods_ir.OpResult[_ods_ir.MemRefType]:
  return ReinterpretCastOp(result=result, input=input, dynamic_offset=dynamic_offset, loc=loc, ip=ip).result
...
def wait_dma(source: _ods_ir.Value[_ods_ir.MemRefType], target: _ods_ir.Value[_ods_ir.MemRefType], wait_target: _Union[bool, _ods_ir.BoolAttr], *, source_semaphore: _Optional[_ods_ir.Value[_ods_ir.MemRefType]] = None, target_semaphore: _Optional[_ods_ir.Value[_ods_ir.MemRefType]] = None, device_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, core_id: _Optional[_ods_ir.Value[_ods_ir.IntegerType]] = None, priority: _Optional[_Union[int, _ods_ir.IntegerAttr]] = None, strict_ordering: _Optional[_Union[bool, _ods_ir.BoolAttr]] = None, loc: _Optional[_ods_ir.Location] = None, ip: _Optional[_ods_ir.InsertionPoint] = None) -> WaitDMAOp:
  return WaitDMAOp(source=source, target=target, wait_target=wait_target, source_semaphore=source_semaphore, target_semaphore=target_semaphore, device_id=device_id, core_id=core_id, priority=priority, strict_ordering=strict_ordering, loc=loc, ip=ip)
