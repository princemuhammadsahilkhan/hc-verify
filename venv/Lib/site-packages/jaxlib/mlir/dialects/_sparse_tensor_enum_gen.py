...
@register_attribute_builder("SparseTensorCrdTransDirectionEnum", allow_existing=True)
...
@register_attribute_builder("SparseTensorSortKindEnum", allow_existing=True)
...
@register_attribute_builder("SparseTensorStorageSpecifierKindEnum", allow_existing=True)
def _sparsetensorstoragespecifierkindenum(x, context):
    return _ods_ir.IntegerAttr.get(_ods_ir.IntegerType.get_signless(32, context=context), int(x))

@register_attribute_builder("sparse_tensor.SparseTensorCrdTransDirectionAttr")
...
@register_attribute_builder("sparse_tensor.SparseTensorSortKindAttr")
...
@register_attribute_builder("sparse_tensor.SparseTensorStorageSpecifierKindAttr")
